...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.fontfg(font, "#e33a6e", cpu_now.usage .. "% "))
    end
})

-- Battery
--local baticon = wibox.widget.imagebox(widget_batt)
...
--        end
--
--        widget:set_markup(markup.fontfg(font, "#aaaaaa", bat_now.perc .. " "))
--    end
--})
...
local volume = lain.widget.alsa({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(font, "#7493d2", volume_now.level .. "% "))
    end
})

-- Net
local netdownicon = wibox.widget.imagebox(widget_netdown)
local netdowninfo = wibox.widget.textbox()
local netupicon = wibox.widget.imagebox(widget_netup)
local netupinfo = lain.widget.net({
    settings = function()
        widget:set_markup(markup.fontfg(font, "#e54c62", net_now.sent .. " "))
        netdowninfo:set_markup(markup.fontfg(font, "#87af5f", net_now.received .. " "))
    end
})
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(font, "#e0da37", mem_now.used .. "M "))
    end
})
